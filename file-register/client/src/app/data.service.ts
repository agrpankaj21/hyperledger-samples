...
export class DataService<Type> {
    ...
    // get historian record from txn id
    //http://localhost:3000/api/system/historian/<txn-id>
    // actionUrl = /api,ns= /system/historian, id = txn-id
    public getHistorianRecord(ns: string, id: string): Observable<Type> {
        var apiurl = this.actionUrl + ns +'/historian' + '/' + id;        
        console.log('getHistorianRecord api url: ' + apiurl);
